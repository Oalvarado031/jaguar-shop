-- ============================================================
-- Jaguar Shop - Script de creacion de BD PostgreSQL
-- Tienda oficial de productos UAM (Universidad Americana)
...
-- Conectarse a la BD jaguar_shop antes de ejecutar lo siguiente.
...
-- Datos iniciales (tematica UAM Jaguar)
